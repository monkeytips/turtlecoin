...
Open the wallets with monkey-serivce like so:

./monkey-service -w walletA.wallet -p yourpass --rpc-password test --bind-port 8070
./monkey-service -w walletB.wallet -p yourpass --rpc-password test --bind-port 8071
