...
function usage()
{
    ...
    echo "and generates the checksum files of the monkeytips tag provided."
    echo
...
# -- Config
GITHUB_REPO="https://github.com/monkeytips/monkeytips.git"
CLONE_DIR="$BUILD_DIRECTORY/monkeytips-buildall"
TARGET_DIR="$BUILD_DIRECTORY/monkeytips-releases"
DYNAMIC_RELEASE="monkeytips-${TAG_VERSION}-linux-CLI"
STATIC_RELEASE="monkeytips-${TAG_VERSION}-linux-staticboost-CLI"
