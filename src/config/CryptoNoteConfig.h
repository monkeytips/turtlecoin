...
const uint64_t MINIMUM_FEE                                   = UINT64_C(2500);
...
const uint64_t BLOCK_BLOB_SHUFFLE_CHECK_HEIGHT               = 800000;
const uint64_t TRANSACTION_INPUT_BLOCKTIME_VALIDATION_HEIGHT = 800000;
...
const size_t   FUSION_TX_MAX_SIZE                            = 12000;
...
{
    {  0x55, 0x7c, 0x51, 0xcf, 0x21, 0xd3, 0xa4, 0x6f, 0xf2, 0xb3, 0x22, 0xa5, 0xb3, 0x74, 0xe4, 0x17  }
};
